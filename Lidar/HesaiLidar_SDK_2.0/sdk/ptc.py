...
default_host = "10.131.117.249" # Change this to your Lidar IP
...
if __name__ == "__main__":
    ss = PTC()
    #print(ss.sender('5', None)) # Example command to 'Get Current Fault Log', change the command code and payload as needed
    print(ss.sender('1c', '01')) # Example command to 'Get Current Fault Log', change the command code and payload as needed
    ss.closeSocket()